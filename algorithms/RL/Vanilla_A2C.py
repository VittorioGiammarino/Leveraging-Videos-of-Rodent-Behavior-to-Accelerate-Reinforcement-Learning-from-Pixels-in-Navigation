...
class Vanilla_A2C:
        ...
        while step < self.num_steps_per_rollout: 
            ...
            # Select action randomly or according to policy
                if self.Total_t < args.start_timesteps:
                    ...
                    action = Vanilla_A2C.select_action(self, state)
    ...
    def train(self):
        ...
        with torch.no_grad():
            if self.action_space == "Discrete":
                _, rollout_old_log_pi = self.actor.sample_log(rollout_states, rollout_actions)

            elif self.action_space == "Continuous": 
                rollout_old_log_pi = self.actor.sample_log(rollout_states, rollout_actions)
