...
class on_off_AWAC_GAE_obs:
    def __init__(self, state_dim, action_dim, action_space_cardinality, max_action, min_action, Domain_adaptation = True, Entropy = True,   
                 ...
                 l_rate_actor=3e-4, l_rate_alpha=3e-4, discount=0.99, tau=0.005, beta=3, gae_gamma = 0.99, gae_lambda = 0.99, minibatch_size=64, num_epochs=10, alpha=0.2, 
    ...
    def GAE_off(self, off_policy_data_tot, ntrajs):
        states = []
        actions = []
        returns = []
        advantage = []
