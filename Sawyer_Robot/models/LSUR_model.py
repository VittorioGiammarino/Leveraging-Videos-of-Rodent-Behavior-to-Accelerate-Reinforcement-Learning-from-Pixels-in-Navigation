...
class SawyerEncoder(nn.Module):
    def __init__(self, class_latent_size = 8, content_latent_size = 32, input_channel = 3, flatten_size = 256):
...
class SawyerDecoder(nn.Module):
    def __init__(self, latent_size = 32, output_channel = 3, flatten_size=256):
