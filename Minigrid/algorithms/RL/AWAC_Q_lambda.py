        ...
        while step < self.num_steps_per_rollout: 
            ...
            with torch.no_grad():
                ...
                if self.action_space == "Discrete":
                    ...
                    pi_action, log_pi, _ = self.actor.sample(episode_states)
                    Q1_on, Q2_on = self.actor.critic_target(episode_states, pi_action)
        ...
        while step < self.num_steps_per_rollout: 
            ...
            with torch.no_grad():
                ...
                if self.action_space == "Discrete":
                    ...
                    Q1_off, Q2_off = self.actor.critic_target(episode_states, episode_actions)
                    values_off = torch.min(Q1_off, Q2_off)
                    
                    pi_action, log_pi, _ = self.actor.sample(episode_states)
                    current_Q1, current_Q2 = self.actor.critic_target(episode_states, pi_action)
