...
class on_off_SAC_obs:
    def __init__(self, state_dim, action_dim, action_space_cardinality, max_action, min_action, Domain_adaptation = True, intrinsic_reward = 0.01,
                 Prioritized = False, l_rate_actor=1e-4, l_rate_critic=3e-4, l_rate_alpha=1e-4, discount=0.99, tau=0.005, 
                 alpha=0.01, critic_freq=2, adversarial_loss = "wgan"): 
